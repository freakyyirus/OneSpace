# OneSpace – Universal Proof-First Portfolio Platform
...
```bash
git clone https://github.com/freakyyirus/OneSpace.git
cd OneSpace/portfolio-app
npm install
```
...
1. Define domain in `portfolio-app/src/lib/domain-engine/domains.ts`
